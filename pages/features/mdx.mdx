...
I wanted to make a documentation site for Javascript in general where you can find code snippets to learning reasources, that might
be useful for you. I wanted to make it as simple as possible, so I decided to use a NextJS based documenation site with 
